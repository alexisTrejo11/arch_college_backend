...
Representative operations include: Enroll student, Get enrollment, My enrollments, Start student preload. The full contract is generated at runtime—use Swagger UI or `docs/APISchema.md` for portfolio alignment with `APISchema` in `docs-schema.ts`.
