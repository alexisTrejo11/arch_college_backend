...
import io.github.alexistrejo11.architecture.college.enrollment.service.implementation.EnrollmentValidationServiceImpl;
...
class EnrollmentValidationServiceImplTest {
    ...
    */
    ...
    void testValidateSubject_ShouldReturnError_WhenSubjectTooFarAhead() {
        ...
        obligatorySubject.setSemester(5);
    ...
    void testValidateMaximumCreditsPerStudent_ExceededCredits() {
        ...
        when(enrollmentRepository.findByStudentAccountNumberAndSchoolPeriod(eq(accountNumber), anyString()))
