...
class ScheduleServiceTest {
    ...
    void validateClassroomSchedule_ShouldReturnError_WhenConflictDetected() {
        ...
        assertEquals("Schedule conflict: Classroom A101 is already assigned for the requested time slot",
    ...
    void validateTeachersSchedule_ShouldReturnError_WhenConflictDetectedForOneTeacher() {
        ...
        // Act
        Result<Void> result = scheduleService.validateTeachersSchedule(teacherIds, schedulesDto, groupId);
