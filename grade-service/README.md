...
Representative operations include: Fetch grade, Authorize grade, Submit grades, Student history. The full contract is generated at runtime—use Swagger UI or [`docs/generated/APISchema.md`](docs/generated/APISchema.md) for portfolio alignment with `APISchema` in `docs-schema.ts`.
