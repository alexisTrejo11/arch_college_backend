...
import io.github.alexistrejo11.architecture.college.student.service.StudentFinderValidator;
...
public class StudentQueryController {
    ...
    public ResponseEntity<ResponseWrapper<StudentDTO>> getStudentById(@PathVariable Long studentId) {
        Result<StudentDTO> studentResult = studentQueryService.getStudentById(studentId);
    ...
    public ResponseEntity<ResponseWrapper<StudentDTO>> getStudentByAccountNumber(@PathVariable String accountNumber) {
        Result<StudentDTO> studentResult = studentQueryService.getStudentByAccountNumber(accountNumber);
        if (!studentResult.isSuccess()) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body(ResponseWrapper.notFound(studentResult.getErrorMessage()));
        }
    ...
    public ResponseEntity<ResponseWrapper<Page<StudentDTO>>> getAllStudentsSortedByFilter(
        ...
        Page<StudentDTO> studentDTOS = studentQueryService.getAllStudentsSortedByFilterPageable(pageable, studentFilter);
    ...
    public ResponseEntity<ResponseWrapper<Page<StudentDTO>>> getStudentsByFilterPageable(
        ...
        Page<StudentDTO> studentDTOS = studentQueryService.getStudentsSortedByFilterPageable(pageable, studentFilter, param);
